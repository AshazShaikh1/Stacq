...
export function AddResourceForm({
  ...
  useEffect(() => {
    const timer = setTimeout(async () => {
      ...
      if (metadata?.title && title === metadata.title) return;
            ...
            {isCreatingSection ? (
              <div className="flex gap-2 animate-in fade-in slide-in-from-left-2 duration-300">
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-12 w-12 rounded-xl text-muted-foreground p-0 hover:bg-destructive/5 hover:text-destructive transition-colors"
                >
                  <X className="w-4 h-4" />
                </Button>
              </div>
                ...
                <SelectContent className="rounded-xl border-border shadow-2xl">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <PlusSquare className="w-4 h-4" />+ Add New Section
                    </div>
                  </SelectItem>
                </SelectContent>
              </Select>
