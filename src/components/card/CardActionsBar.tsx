      ...
      <div className="relative h-full group">
        ...
        >
          ...
          >
            ...
            {!hideHoverButtons && (
              <div className="absolute top-3 right-3 z-20 flex gap-2 transition-opacity duration-200 opacity-100 md:opacity-0 md:group-hover:opacity-100">
                <button
                  onClick={handleShare}
          ...
          <div className="p-4 flex-1 flex flex-col relative pointer-events-none">
            ...
            <div className="mt-auto pt-2 flex items-center justify-between gap-2">
              ...
              {card.creator?.display_name && (
                <div
                  className="mt-auto pt-2 flex justify-end pointer-events-auto"
                  onClick={(e) => e.stopPropagation()}
                >
                  <Link
