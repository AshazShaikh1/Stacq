  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center px-6 text-center space-y-6">
      ...
      <p className="text-lg text-muted-foreground max-w-md mx-auto font-medium">
        The collection or profile you&apos;re looking for doesn&apos;t exist,
        has been deleted, or is set to private.
      </p>

      <div className="pt-4">
        <Link
          href="/"
          className="inline-flex items-center justify-center bg-foreground text-background font-bold px-8 py-4 rounded-full hover:bg-foreground/90 transition-colors shadow-lg active:scale-95"
        >
          Return to Home
        </Link>
      </div>
